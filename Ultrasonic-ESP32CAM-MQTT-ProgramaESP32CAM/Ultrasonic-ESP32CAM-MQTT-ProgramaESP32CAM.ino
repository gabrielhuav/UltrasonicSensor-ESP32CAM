 ...
 * 
 * Este programa lee el sensor ultrasonico con la biblioteca Ultrasonico de Erick Simoes
 * en su versión 3.0.0. Se mezcla con el programa ESP32CAM-MQTT-basic del repositorio de
 * Codigo-IOT.
 * 
 * Este programa también envía datos  por Internet a través del protocolo MQTT. Para
...
const char* mqtt_server = "192.168.1.104"; // Si estas en una red local, coloca la IP asignada, en caso contrario, coloca la IP publica
